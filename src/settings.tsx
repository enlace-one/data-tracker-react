...
export const supportLink = "https://www.patreon.com/EnlaceOne";
...
export const DEFAULT_TOPICS = [
  ...
  { name: "Cake (Black)", imageLink: "cake-black.svg" },
  { name: "Cake (Blue)", imageLink: "cake-blue.svg" },
  { name: "Cake (Colorful)", imageLink: "cake-colorful.svg" },
  { name: "Cake (Cyan)", imageLink: "cake-cyan.svg" },
  { name: "Cake (Green)", imageLink: "cake-green.svg" },
  { name: "Cake (Purple)", imageLink: "cake-purple.svg" },
  { name: "Cake (Red)", imageLink: "cake-red.svg" },
